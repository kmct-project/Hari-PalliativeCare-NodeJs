...
///////ALL appointment/////////////////////                                         
router.get("/all-appointments", verifySignedIn, function (req, res) {
  let administator = req.session.admin;
  adminHelper.getAllappointments().then((appointments) => {
    res.render("admin/all-appointments", { admin: true, layout: "adminlayout", appointments, administator });
  });
});
